...
function Projects() {
    ...
    return (
        ...
        <div className="project-card-view card fade-in">
            ...
            <img width="400" height="250" alt="image" src="https://github.com/user-attachments/assets/7d2127c8-7b49-4d7d-ab50-1a4b57fefcc8" />
        </div>
        ...
        <a href="https://github.com/HardikMarlapudi/Forms" target="_blank" id="formsApplication">Forms Application</a>
            ...
            <img width="400" height="250" alt="forms" src="https://github.com/user-attachments/assets/df8a66c4-d2fa-4b79-bb35-a9bc8d578413" />
        </div>
        ...
        <a href="https://github.com/HardikMarlapudi/BMI-Calculator" target="_blank" id="bmiCalculator">BMI Calculator</a>
            ...
            <img width="400" height="250" alt="image" src="https://github.com/user-attachments/assets/0a4c1019-2343-472c-9525-a7fb175d786c" />
        </div>
        ...
        <a href="https://github.com/HardikMarlapudi/Portfolio" target="_blank" id="portfolio">Portfolio</a>
            ...
            <img width="400" height="250" alt="image" src="https://github.com/user-attachments/assets/9c8c084e-bf9f-4eb4-ad33-b5870f9ddc56" />
        </div>
        </>
    )
}
