  ...
  return (
    <nav className="navbar">
      ...
      <ul id="primary-navigation" className={`nav-links ${menuOpen ? 'open' : ''}`}>
        ...
        <li>
         <NavLink to="/resume" onClick={closeMenu} className={({ isActive }) => (isActive ? 'active' : '')}>Resume</NavLink>
        </li>

        <li>
        <NavLink to="/Achievements" onClick={closeMenu} className={({ isActive }) => (isActive ? 'active' : '')}>Achivements</NavLink>
        </li>
